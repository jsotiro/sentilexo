...
public class TwitterJSONLoader {
   private static Logger log = LoggerFactory.getLogger(TwitterJSONLoader.class);
   int linesRead  =0;
   int statusesRead  =0;
   int filesRead  =0;
   File currentFile;
   String filename;
   protected String  queryOwner;
...
public  int importFilesFromPath(String basePath) {
    ...
    protected  void readFileLines(File fileName) throws IOException {
    ...
    protected void handleStatusObject() {
