 ...
 * @author yanni
 */
public class QueryResultItemTemplate implements Serializable {
    ...
    public QueryResultItemTemplate() {
    }
    
    

    public QueryResultItemTemplate(long statusId) {
    ...
    public void setQueryOwner(String queryName) {
        this.queryName = queryOwner;
    }
