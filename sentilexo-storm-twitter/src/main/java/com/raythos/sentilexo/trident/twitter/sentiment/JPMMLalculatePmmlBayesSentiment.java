...
import static com.raythos.sentilexo.trident.twitter.sentiment.CalculateNLPSentiment.log;
...
public class JPMMLalculatePmmlBayesSentiment extends BaseFunction { 
    ...
    public void execute(TridentTuple tuple, TridentCollector collector) {
        ...
        try {
            ...
            resultCreationDate.setTime(((Long)result.get(QueryResultItemFieldNames.CREATED_AT)));
